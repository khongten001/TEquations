...
You just need to import the content of this folder and include `Equation.h` as header in your program. Here's a step-by-step guide that's good for Visual Studio:
 ...
 4. Go on Project > Add Existing Items > Navigate to the project folder > Select the Parser folder and the h/cpp files called Equation and Fraction
 5. Click Add. Now you can type #include `"Equation.h"` and jump to the next section!
